  ...
  <AppCardDefault>
    <template #content>
      <v-card elevation="0" class="card">
        <v-card-title class="text-h6 text-fontdark font-weight-bold mt-5 px-8">
          Usuários cadastrados
        </v-card-title>

        <v-card-text
          class="font-weight-regular text-fontdark text-subtitle-2 mt-5 px-0"
        >
          <v-table>
            <thead class="header">
              <tr>
